<template>
  <div class="ai-analysis-panel">
    ...
    <!-- 示例问题 -->
    <div v-if="!analysisResult" class="example-section">
      <div class="example-header">
        <div class="example-title">💡 试试这些问题：</div>
        <el-button link type="primary" size="small" @click="displayExamples = getRandomExamples()">
...
const exampleCategories = ref([
  ...
  {
    category: '🏫 班级对比',
    examples: ['哪些班级需要重点关注？', '各年级正确率对比分析', '班级答题活跃度排名']
  },
  {
    category: '📚 学科分析',
    examples: ['语文学科的主要薄弱点在哪里？', '各学科题目分布情况', '学科难度分布统计']
  },
  {
    category: '👥 用户行为',
    examples: ['用户答题频次分布情况', '答题时间分布分析', '最活跃的学生有哪些？']
  }
])
