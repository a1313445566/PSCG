  ...
  <el-card class="setting-card" shadow="hover">
    ...
    <div class="setting-section">
      <div class="setting-row">
        ...
        <div class="setting-controls">
          <el-button :type="localRandomizeAnswers ? 'primary' : 'default'" @click="localRandomizeAnswers = true">开启</el-button>
          <el-button :type="!localRandomizeAnswers ? 'primary' : 'default'" @click="localRandomizeAnswers = false">关闭</el-button>
        </div>
      ...
      <div class="setting-row">
        ...
        <div class="setting-controls">
          <el-button :type="localRandomizeErrorCollectionAnswers ? 'primary' : 'default'" @click="localRandomizeErrorCollectionAnswers = true">开启</el-button>
          <el-button :type="!localRandomizeErrorCollectionAnswers ? 'primary' : 'default'" @click="localRandomizeErrorCollectionAnswers = false">关闭</el-button>
        </div>
    ...
    <div class="setting-section">
      ...
      <div class="setting-row">
        ...
        <div class="setting-controls">
          <el-button :type="!localFixedQuestionCount ? 'primary' : 'default'" @click="localFixedQuestionCount = false">随机</el-button>
          <el-button :type="localFixedQuestionCount ? 'primary' : 'default'" @click="localFixedQuestionCount = true">固定</el-button>
        </div>
        <template v-if="!localFixedQuestionCount">
          <el-input-number v-model="localMinQuestionCount" :min="1" :max="50" style="width: 100px;" />
          <span class="range-text">至</span>
          <el-input-number v-model="localMaxQuestionCount" :min="1" :max="50" style="width: 100px;" />
          <span class="setting-status active">当前范围：{{ localMinQuestionCount }}-{{ localMaxQuestionCount }}题</span>
        </template>
        <template v-else>
          <el-input-number v-model="localFixedQuestionCountValue" :min="1" :max="50" style="width: 100px;" />
...
watch(() => props.randomizeAnswers, (v) => localRandomizeAnswers.value = v);
watch(() => props.randomizeErrorCollectionAnswers, (v) => localRandomizeErrorCollectionAnswers.value = v);
watch(() => props.fixedQuestionCount, (v) => localFixedQuestionCount.value = v);
watch(() => props.minQuestionCount, (v) => localMinQuestionCount.value = v);
watch(() => props.maxQuestionCount, (v) => localMaxQuestionCount.value = v);
watch(() => props.fixedQuestionCountValue, (v) => localFixedQuestionCountValue.value = v);
