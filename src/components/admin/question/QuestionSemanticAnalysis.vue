<template>
  <el-card class="semantic-analysis-card" shadow="hover">
    ...
    <div class="question-selector">
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item label="学科">
          <el-select v-model="searchForm.subjectId" placeholder="选择学科" clearable style="width: 150px">
            <el-option
    ...
    <div v-if="questionList.length > 0" class="question-list">
      <el-table :data="questionList" style="width: 100%" @row-click="handleSelectQuestion" highlight-current-row>
    ...
    >
      <div v-if="currentAnalysis" v-loading="loadingAnalysis" class="analysis-content">
        ...
        <!-- 关键词 -->
        <div class="keywords-section" v-if="parsedKeywords.length > 0">
        ...
        <!-- 自动标签 -->
        <div class="tags-section" v-if="parsedAutoTags.length > 0">
          <div class="section-title">
        ...
        <!-- 知识点 -->
        <div class="knowledge-section" v-if="parsedKnowledgePoints.length > 0">
          <div class="section-title">
        ...
        <!-- 难度因素 -->
        <div class="difficulty-section" v-if="parsedDifficultyFactors">
          <div class="section-title">
        ...
        <!-- AI 建议 -->
        <div class="suggestion-section" v-if="currentAnalysis.ai_suggestion">
          <div class="section-title">
        ...
        <!-- 相似题目 -->
        <div class="similar-section" v-if="similarQuestions.length > 0">
          <div class="section-title">
            <el-icon><Connection /></el-icon>
            相似题目推荐
            <el-button 
          ...
          <div class="similar-list">
            ...
            >
              ...
              <div class="similar-meta">
                ...
                <el-tag size="small" type="info">{{ question.type === 'single' ? '单选' : '多选' }}</el-tag>
        ...
        <div class="analysis-info">
          ...
          <el-text type="info" size="small" v-if="currentAnalysis.last_analyzed_at">
...
import { 
  Document, MagicStick, Key, CollectionTag, 
  Reading, DataAnalysis, ChatDotRound, Connection, Search
