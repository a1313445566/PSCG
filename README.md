...
### 文档目录结构
- **技术文档** (`DOCS/技术文档/`) - 系统架构、技术实现、问题排查等
  - 技术文档.md - 系统整体技术架构说明
  - 性能监控功能集成指南.md - 性能监控功能详细指南
  - 时间问题修复记录.md - 时间相关问题修复记录
  - 故障排除指南.md - 系统故障诊断和解决方法
  - 项目清理报告.md - 项目清理工作记录
  - 测试性能监控API.sh - API测试脚本
- **API文档** (`DOCS/API文档/`) - 完整的API接口文档
  - API.md - 所有API接口详细文档
- **使用指南** (`DOCS/使用指南/`) - 用户和开发者快速指南
  - API使用/ - API接口使用相关指南
  - 后台管理/ - 后台管理系统使用指南
  - 学生端/ - 学生端使用指南
  - 系统管理/ - 系统管理相关指南
  - 性能监控功能快速指南.md - 性能监控快速上手指南
- **需求文档** (`DOCS/需求文档/`) - 功能需求和规划文档
  - 后台数据加载优化需求文档.md
  - 学科自动错题巩固题库需求.md
  - VMind 自然语言交互失败文档.md
- **部署文档** (`DOCS/部署文档/`) - 部署配置和运维指南
  - cloudflared隧道设置指南.md - 内网穿透隧道设置
  - 系统部署配置指南.md - 完整的系统部署配置指南
- **开发文档** (`DOCS/开发文档/`) - 开发规范和代码标准
  - 编码规范.md - 代码编写规范
...
# 查看测试指南
cat DOCS/开发文档/测试指南.md
```

详细文档说明请查看：`DOCS/目录结构说明.md`
