...
| `DOCS/API文档/API.md` | 完整 API 接口文档 |
| `DOCS/技术文档/安全架构文档.md` | 安全架构设计（认证、签名、限流） |
| `DOCS/部署文档/系统部署配置指南.md` | 生产环境部署指南 |
| `DOCS/技术文档/故障排除指南.md` | 常见问题排查 |

### 文档目录

- **API文档/** - RESTful API 接口文档
- **技术文档/** - 技术架构、安全设计、功能实现、故障排查
- **使用指南/** - 用户操作指南（学生端、后台管理、系统管理）
- **开发文档/** - 编码规范、开发环境、测试指南
- **部署文档/** - 系统部署、运维配置
- **需求文档/** - 功能需求分析
